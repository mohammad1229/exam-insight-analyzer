...
export default defineConfig(({ mode }) => ({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'نظام تحليل نتائج الاختبارات',
        short_name: 'تحليل الاختبارات',
        description: 'نظام متكامل لإدارة وتحليل نتائج اختبارات الطلاب',
        theme_color: '#10b981',
      ...
      workbox: {
        ...
        runtimeCaching: [
          {
            urlPattern: /^https:\/\/uqssjjkrudpbibawoaua\.supabase\.co\/.*/i,
